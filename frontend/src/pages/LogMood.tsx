...
import { Heart, Zap, Wind, Coffee, Smile, MessageSquare, CheckCircle, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fff6f6] px-6 py-10">
      ...
      {showSuccess && apiResult && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl text-center border-4 border-[#fceaea]">
            ...
            <button
              onClick={() => navigate("/")}
              className="w-full bg-[#e5989b] text-white py-4 rounded-xl font-bold hover:bg-[#d88a8d] transition-all shadow-md"
            >
              Back to Dashboard
            </button>
          </div>
